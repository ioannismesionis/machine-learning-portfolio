...
const ExperiencePage = () => {
  const experiences = [
    ...
    },
    {
      ...
      skills: ["Technical Leadership", "ML Engineering", "CI/CD", "Test-driven Development", "Data & Model Drift Monitoring"],
      icon: FaBriefcase
    },
    {
      type: "work",
      ...
      skills: ["Survival Analysis", "Web Scraping", "BeautifulSoup", "Selenium", "Python"],
      icon: FaBriefcase
    },
    {
      type: "work",
      ...
      description: "Applied market analysis frameworks (PESTEL, SWOT) to assess megatrends, disruptive innovation, and customer insights across multiple industries.",
      skills: ["Market Analysis", "Disruptive Innovation", "Strategic Frameworks (PESTEL, SWOT)", "Consulting"],
      icon: FaBriefcase
    },
    {
      type: "work",
      ...
      skills: ["Predictive Modeling", "Lasso Regression", "Random Forest", "SVM", "Regularisation"],
      icon: FaBriefcase
    }
  ];
